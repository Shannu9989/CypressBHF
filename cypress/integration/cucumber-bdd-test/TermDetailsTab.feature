Feature: Term Details Tab Regression suite

     As a user I should be able to test Term Details Tab in CSR Portal.
    ...
    Scenario:  User should be able to see the authorized policy, date and reason in My call History Widget
        Then   User should see the authorized policy in My Call History Widget
    ...
    Scenario:  User should be able to see the Funds Tab checked fields in Call Details Widget
        Then   User should be able to see 'FUNDS' in Call Details Widget
         And   User should be able to see Funds tab Message 'Funds not applicable for this product' in Call Details Widget
