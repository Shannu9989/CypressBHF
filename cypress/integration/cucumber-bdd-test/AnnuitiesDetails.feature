Feature: Annuities Details Tab Regression suite

     As a user I should be able to test Annuities Details Tab in CSR Portal.
    ...
    Scenario:  User should be able to see the Values Tab checked fields in Call Details Widget
        Then   User should be able to see 'VALUES' in Call Details Widget
         ...
         And   User should be able to see Free out Amount Label in Call Details Widget    
         And   User should be able to see Free out Amount in Call Details Widget
         ...
         And   User should be able to see Quoted Free out Amount Label in Call Details Widget 
         And   User should be able to see Quoted Free out Amount in Call Details Widget 
    ...
    Scenario:  User should be able to see the Loans Tab checked fields in Call Details Widget
        Then   User should be able to see 'LOAN' in Call Details Widget
         And   User should be able to see Loan tab Message 'Loans  not applicable for this product' in Call Details Widget
    ...
    Scenario:  User should be able to see the Funds Tab checked fields in Call Details Widget
        Then   User should be able to see 'FUNDS' in Call Details Widget
         And   User should be able to see 'Name' Label in Call Details Widget
         ...
         And   User should be able to see Type or Future Allocation Label in Call Details Widget   
         And   User should be able to see Type or Future Allocation in Call Details Widget 
         And   User should be able to see Total Contract or Unit Value Label in Call Details Widget 
         And   User should be able to see Total Contract or Unit Value in Call Details Widget 
